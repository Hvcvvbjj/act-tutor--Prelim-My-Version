...
const LESSON_CONFIG = {
  ...
  "logical-transitions": {
    ...
    prompt:
      "The first trial failed. ___, the team changed the design before testing again.",
    answer: "Therefore",
    explanation: [
  ...
  "functions-and-modeling": {
    ...
    answer: "78",
    explanation: ["Substitute 4 for n: 12(4) + 30.", "Compute 48 + 30 = 78."],
  ...
  "ratios-and-percent": {
    ...
    answer: "12",
    explanation: ["15% is 0.15.", "0.15 times 80 equals 12."],
  ...
  "central-ideas-and-details": {
    ...
    prompt:
      "A passage describes three failed prototypes, then a final useful design.",
...
const PRACTICE_CONFIG = {
  "sentence-boundaries": [
    [
      "Although the rain stopped, the match.",
      "Fragment",
      "The second part has no working verb, so the thought is incomplete.",
    ],
    [
      "The lab opened early, students arrived before sunrise.",
      "Run-on",
      "Two complete sentences are joined only by a comma.",
    ],
    [
      "The writer revised the draft before class began.",
      "Complete",
      "The sentence has a subject, verb, and complete thought.",
    ],
    [
      "Because the batteries died during the test.",
      "Fragment",
      "Because makes the clause dependent, and no independent clause follows.",
    ],
    [
      "The museum closed at five; visitors gathered outside.",
      "Correct punctuation",
  ...
  "concision-and-redundancy": [
    [
      "The result was completely final.",
      "final",
      "Final already means complete, so completely repeats the idea.",
    ],
    [
      "She returned back to the studio.",
      "returned",
      "Returned already includes the idea of back.",
    ],
    [
      "The brief summary covered the main points.",
      "brief summary",
      "Brief and summary work together without forced repetition here.",
    ],
    [
      "They collaborated together on the mural.",
      "collaborated",
      "Collaborated already means worked together.",
    ],
    [
      "The reason is because the pipe froze.",
      "because",
      "Use either the reason is that or because; both together are wordy.",
    ],
  ],
  "punctuation-and-commas": [
    [
      "The chef, who trained in Lima, opened a cafe.",
      "Keep both commas",
      "The middle clause is nonessential and needs paired commas.",
    ],
    [
    ...
    [
      "My brother Leo plays violin.",
      "No comma",
      "Leo is essential if brother needs identification.",
    ],
  ],
  "logical-transitions": [
    [
      "The device was cheaper than expected. ___, it broke after one week.",
      "However",
      "The second sentence contrasts price advantage with poor durability.",
    ],
    [
      "The soil was dry. ___, the gardener watered the beds.",
      "Therefore",
      "The watering is a result of the dry soil.",
    ],
    [
      "The team measured wind speed. ___, it recorded air temperature.",
      "Additionally",
      "The second action adds another measurement.",
    ],
    [
      "The route was longer. ___, it avoided the flooded bridge.",
      "Still",
      "The second idea explains why the longer route remained useful.",
    ],
    [
      "The first plan required permits. ___, the group chose a simpler plan.",
      "Consequently",
      "The choice follows as a result of the permit problem.",
    ],
  ],
  "linear-equations": [
    ...
    [
      "Solve -2x + 9 = 1.",
      "4",
      "Subtract 9 to get -2x = -8, then divide by -2.",
    ],
  ],
  "functions-and-modeling": [
    ["If f(x) = 2x + 3, what is f(5)?", "13", "Substitute 5: 2(5) + 3 = 13."],
    [
      "A cab cost is C(m) = 4m + 6. What does 6 represent?",
      "Starting fee",
      "It is the cost when m is zero.",
    ],
    [
      "If g(t) = t^2 - 1, what is g(4)?",
      "15",
      "4 squared is 16, and 16 - 1 = 15.",
    ],
    [
      "If h(x) = 18 - 3x, what input gives h(x) = 6?",
      "4",
      "18 - 3x = 6, so x = 4.",
    ],
    [
      "A plant is 5 inches tall and grows 2 inches per week. Which model fits?",
      "H(w) = 5 + 2w",
      "The starting value is 5 and the weekly rate is 2.",
    ],
  ],
  "ratios-and-percent": [
    [
      "What is 20% of 45?",
      "9",
      "20 percent is one fifth, and one fifth of 45 is 9.",
    ],
    [
    ...
    [
      "A class has 12 juniors and 18 seniors. What percent are juniors?",
      "40%",
      "12 out of 30 students is 40 percent.",
    ],
  ...
  "geometry-and-measurement": [
    ...
    [
      ...
      "26",
      "Perimeter is 2(8 + 5) = 26.",
    ],
    [
      "A right triangle has legs 6 and 8. What is the hypotenuse?",
      "10",
      "Use 6-8-10 or the Pythagorean theorem.",
    ],
    [
      "A box is 4 by 3 by 5. What is its volume?",
      "60",
  ...
  "central-ideas-and-details": [
    [
      "A passage traces a scientist's repeated tests and revisions. What is the central idea?",
      "Progress came through revision",
      "The repeated testing pattern controls the passage.",
    ],
    [
      "A paragraph mainly lists causes of a town's growth. What should a main-idea answer emphasize?",
      "Reasons the town grew",
      "The paragraph's job is explaining causes.",
    ],
    [
      "If three paragraphs compare old and new maps, what answer is too narrow?",
      "One map used blue ink",
      "That is one detail, not the whole passage's point.",
    ],
    [
      "A passage describes a problem, failed fixes, and a final solution. What is the best central frame?",
      "How a problem was solved",
      "The structure centers on moving from problem to solution.",
    ],
    [
      "A passage profiles an artist's changing style over decades. What is central?",
      "The artist's style evolved",
      "The full passage tracks change over time.",
    ],
  ],
  "supported-inference": [
    [
      "A character saves receipts and checks prices twice. What is supported?",
      "The character is careful with spending",
      "The details support caution about money.",
    ],
    [
      "A researcher repeats a trial after a surprising result. What is supported?",
      "The researcher wants more reliable evidence",
      "Repeating a trial strengthens confidence.",
    ],
    [
      "A narrator avoids the main road after seeing dark clouds. What is supported?",
      "The narrator expects bad weather may affect travel",
      "The action connects clouds to route choice.",
    ],
    [
      "A student whispers before entering the auditorium. What is supported?",
      "The setting likely requires quiet",
      "Whispering supports a quiet expectation.",
    ],
    [
      "A shop extends hours after long lines form. What is supported?",
      "Demand exceeded the shop's earlier schedule",
      "Long lines explain the schedule change.",
    ],
  ],
  "textual-evidence-and-details": [
    [
    ...
    [
      "A paragraph says the sensor lowered errors by 12%. What is supported?",
      "The sensor made measurements more accurate",
      "Lower errors indicate improved accuracy.",
    ],
    [
      "The text states Mara left before dawn to avoid heat. Why did she leave early?",
      "To avoid heat",
      "The reason is stated directly.",
    ],
    [
      "The passage notes the fabric repels water but tears easily. Which is supported?",
      "It has both a benefit and a weakness",
      "Both properties are explicitly described.",
    ],
    [
      "The author says the second edition added maps. What changed?",
      "Maps were added",
      "The detail is stated without needing inference.",
    ],
  ],
  "author-purpose-and-structure": [
    [
      "An author gives a personal anecdote before statistics. What is the likely purpose?",
      "To introduce the issue through an example",
      "The anecdote makes the issue concrete before data appears.",
    ],
    [
      "A paragraph begins with critics' objections, then answers them. What is its job?",
      "Address counterarguments",
      "It presents objections so they can be answered.",
    ],
    [
      "Why include a definition before a technical explanation?",
      "To clarify a key term",
      "The definition prepares readers for the explanation.",
    ],
    [
      "A final paragraph returns to the opening image. What is the structural purpose?",
      "Create a closing connection",
      "Returning to an opening image frames the ending.",
    ],
    [
      "An author contrasts two methods before choosing one. What is the purpose?",
      "To justify the preferred method",
      "The contrast explains why one method is better suited.",
    ],
  ],
} as const;
...
const PRACTICE_DISTRACTORS = {
  ...
  "concision-and-redundancy": [
    ...
    [
      "summary",
      "brief and short summary",
      "summary of the main points in brief",
    ],
    [
      "collaborated together",
      "worked collaboratively together",
      "jointly collaborated together",
    ],
    [
      "The reason is because",
      "The reason why is due to",
      "Due to the reason being that",
    ],
  ],
  "punctuation-and-commas": [
    [
      "Remove the first comma only",
      "Remove the second comma only",
      "Remove both commas",
    ],
    [
      "Remove the comma",
      "Replace the comma with a semicolon and keep and",
      "Add a second comma after hikers",
    ],
    [
      "Keep the comma",
      "Delete all punctuation",
      "Add and without changing the comma",
    ],
    [
      "Add a comma after lecture",
      "Add a comma after students",
      "No comma is needed",
    ],
    [
      "Add commas around Leo",
      "Add a comma before plays",
  ...
  "central-ideas-and-details": [
    [
      "The scientist preferred the first test",
      "The laboratory equipment was expensive",
      "One revision changed a measurement",
    ],
    [
      "The date the town was founded",
      "One resident's opinion of the town",
      "The town's current population only",
    ],
    [
      "The maps changed how people traveled",
      "The two maps served different purposes",
      "Old and new maps share several features",
    ],
    [
      "Why every proposed fix failed",
      "Who first discovered the problem",
      "A description of the problem only",
    ],
    [
      "The artist used one material for decades",
      "The artist's childhood home",
      "One painting's auction price",
    ],
  ],
  "supported-inference": [
    [
      "The character never buys anything",
      "The character works as an accountant",
      "The receipts are required by law",
    ],
    [
      "The researcher expected the result to fail",
      "The first trial was definitely incorrect",
      "The researcher wants a different outcome",
    ],
    [
      "The main road is permanently closed",
      "The narrator is lost",
      "Dark clouds always cause flooding",
    ],
    [
      "The student is afraid of audiences",
      "The auditorium is empty",
      "The student has lost their voice",
    ],
    [
      "The shop lowered every price",
      "The earlier schedule was illegal",
      "Customers requested fewer products",
    ],
  ],
  "textual-evidence-and-details": [
    [
      "The bridge was built in exactly one year",
      "The bridge closed in 1920",
      "The bridge was the first in the region",
    ],
    [
      "The sensor eliminated every error",
      "The sensor was 12% cheaper",
      "Measurements took 12% less time",
    ],
    [
      "To see the sunrise",
      "To arrive before everyone else",
      "To avoid traffic",
    ],
    [
      "It is inexpensive to manufacture",
      "It performs equally well in every condition",
      "Its weakness is water damage",
    ],
    [
      "The maps were removed",
      "The text was shortened",
      "A second author was added",
    ],
  ],
  "author-purpose-and-structure": [
    [
      "To replace the statistics with opinion",
      "To prove the issue affects only one person",
      "To reveal the author's final conclusion",
    ],
    [
      "Introduce an unrelated historical detail",
      "Repeat the critics' claims as facts",
      "Avoid taking a position",
    ],
    [
      "To make the explanation more technical",
      "To delay the passage's main idea",
      "To contradict the later explanation",
    ],
    [
      "Introduce a completely new argument",
      "Show that the opening image was inaccurate",
      "Summarize every detail in order",
    ],
    [
      "To show both methods are identical",
      "To avoid explaining either method",
      "To prove the rejected method never works",
    ],
  ],
} as const;
...
const MISCONCEPTION_BY_SKILL: Record<string, string> = {
  "sentence-boundaries":
    "Recheck whether each clause has a subject, working verb, and complete thought before naming the boundary.",
  "concision-and-redundancy":
    "This choice keeps or creates wording that repeats an idea without adding meaning.",
  "punctuation-and-commas":
    "Name the grammatical role of the phrase or clause before choosing punctuation; do not punctuate by pause.",
  "logical-transitions":
    "This transition signals a different relationship from the one created by the surrounding sentences.",
  "linear-equations":
    "Substitute this value into the original equation; it comes from undoing an operation or sign incorrectly.",
  "functions-and-modeling":
    "Check the input, operation order, and what each coefficient or constant represents in context.",
  "ratios-and-percent":
    "Identify the whole and the scale factor before calculating; this choice uses the wrong reference quantity.",
  "geometry-and-measurement":
    "This choice uses the wrong formula, scale factor, or linear-versus-area relationship.",
  "central-ideas-and-details":
    "This choice is too narrow, unsupported, or misses the pattern controlling the whole passage.",
  "supported-inference":
    "This choice adds a motive, certainty, or fact that the supplied evidence does not establish.",
  "textual-evidence-and-details":
    "The passage states a different detail; return to the exact wording before paraphrasing it.",
  "author-purpose-and-structure":
    "This choice does not describe the actual job the referenced part performs in the passage.",
};

function practicePrompt(skill: SkillDefinition, source: string) {
  if (skill.section !== "english") return source;
  if (skill.slug === "sentence-boundaries")
    return "Which choice best describes the sentence as written?";
  if (skill.slug === "concision-and-redundancy")
    return "Which choice is the most concise revision that preserves the meaning?";
  if (skill.slug === "punctuation-and-commas")
    return "Which choice uses punctuation correctly?";
...
export const ACT_PRACTICE_QUESTIONS = ACT_SKILLS.flatMap((skill) =>
  PRACTICE_CONFIG[skill.slug].map(([prompt, answer, rationale], index) => {
    const reviewedHardExample =
      index === 4
        ? REVIEWED_ACT_QUESTION_EXAMPLES.find(
            (example) => example.skill === skill.slug,
          )
        : null;
    if (reviewedHardExample) {
      return {
        ...
        difficulty: "hard",
        prompt: reviewedHardExample.prompt,
        ...(reviewedHardExample.stimulus
          ? { stimulus: reviewedHardExample.stimulus }
          : {}),
        choices: reviewedHardExample.choices,
        correctChoiceId: reviewedHardExample.correctChoiceId,
        rationale: reviewedHardExample.rationale,
        content: CONTENT_META,
      };
    }
    return {
...
export function getPracticeForSkill(skillSlug: string) {
  return ACT_PRACTICE_QUESTIONS.filter(
    (question) => question.skill === skillSlug,
  );
}
